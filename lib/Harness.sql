...
CREATE TABLE `flags` (
  `flag` enum('ahem','animated','combo','dom','font','history','http','HTMLonly','image','interact','invalid','namespace','nonHTML','may','paged','reftest','should','scroll','svg','userstyle','32bit','96dpi') NOT NULL default 'ahem',
...
CREATE TABLE `testcases` (
  ...
  `flags` set('ahem','animated','combo','dom','font','history','http','HTMLonly','image','interact','invalid','namespace','nonHTML','may','paged','reftest','should','scroll','svg','userstyle','32bit','96dpi') default NULL,
