...
define('FLAGS_MAX_FLAG', 15);
define('FLAGS_MAX_DESCRIPTION', 255);
define('FLAGS_MAX_SET_TEST', 255);
define('FLAGS_MAX_UNSET_TEST', 255);
...
define('TESTCASES_MAX_FLAGS', 255);
...
define('TESTSUITES_MAX_OPTIONAL_FLAGS', 127);
