...
var annotator = {
  QUERY_URI:          "<?php echo Harness::ExternalPageURI('api.status'); ?>",
  STYLESHEET_URI:     "<?php echo Harness::ExternalConfigURI('stylesheet.annotation'); ?>",
  NEED_TEST_ICON_URI: "<?php echo Harness::ExternalConfigURI('image.please_help'); ?>",
